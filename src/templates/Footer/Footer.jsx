...
const Footer = () => {
    ...
    return (
        <footer className=" w-full font-rale bg-gradient-to-r from-gray-800 to-gray-600  text-white border-t-2  border-white txt-sha text-md  p-2 md:flex items-center justify-around text-center font-disp">
            <h1 className="text-">
                Made With&nbsp;{" "}
